...
/**
 * PerformersController implements the CRUD actions for Performers model.
 */
class PerformersController extends Controller
{
    ...
    /**
     * Displays a single Performers model.
     * @param int $id ID
     * @return string
    ...
    {
        if (($model = Performers::findOne(['id' => $id])) !== null) {
            return $model;
        }
